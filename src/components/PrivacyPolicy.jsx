        ...
        <div>
          ...
          <ul>
            <li>
              ...
              Unsere Website erhebt keine personenbezogenen Daten wie
              IP-Adressen oder andere Tracking-Informationen automatisch. Wir
              verwenden keine Webanalysen, Tracking oder andere
              Drittanbieter-Marketing-Tools.
            </li>
            <li>
              <strong>Kontakt per E-Mail:</strong> Wenn Sie uns per E-Mail
              kontaktieren, werden Ihre personenbezogenen Daten (wie Ihr Name
              und Ihre E-Mail-Adresse) nur zur Beantwortung Ihrer Anfrage
              verwendet. Diese Informationen werden nicht an Dritte
              weitergegeben.
            </li>
          </ul>
          ...
          <ul>
            <li>
              ...
              Cookies im Zusammenhang mit der Wiedergabe von YouTube-Videos.
              Diese Cookies werden nur aktiviert, wenn Sie über unser
              Cookie-Banner Ihre Zustimmung geben.
            </li>
            <li>
              <strong>YouTube-Videos:</strong> Wir betten YouTube-Videos
              mithilfe von iFrames ein. Wenn Sie den Cookies zustimmen, kann
              YouTube Cookies setzen, um Ihre Wiedergabeaktivitäten zu
              verfolgen. Weitere Informationen finden Sie in der{" "}
              <a
          ...
          <ul>
            <li>
              ...
              verwendet FontAwesome und Google Fonts, die beide lokal auf
              unserem Server gehostet werden. Es werden daher keine
              personenbezogenen Daten an externe Dienste für das Laden der
              Schriftarten weitergegeben.
            </li>
          </ul>
          ...
          <p>
            ...
            Sicherheits- und Wartungszwecken verarbeiten. Weitere Informationen
            zu den Datenschutzpraktiken finden Sie in der{" "}
            <a
          ...
          <p>
            ...
            aktualisieren. Bitte überprüfen Sie diese Seite regelmäßig auf
            Änderungen.
          </p>

          <h2>8. Kontakt</h2>
          <p>
            Wenn Sie Fragen zu dieser Datenschutzerklärung haben, kontaktieren
            Sie uns bitte unter:
            <br />
            {content.contact.map((item, idx) => (
              <span key={idx}>
    ...
    <>
      {content ? (
        <div>
          ...
          <ul>
            <li>
              <strong>No Personal Data Automatically Collected:</strong> Our
              website does not automatically collect personal data about
              visitors, such as IP addresses or other tracking information. We
              do not use web analytics, tracking, or other third-party marketing
              tools.
            </li>
            <li>
              <strong>Contact via Email:</strong> If you contact us via email,
              your personal data (such as your name and email address) will only
              be used to respond to your inquiry. We do not share this
          ...
          <ul>
            <li>
              ...
              related to YouTube video playback. These cookies are only
              activated if you give consent through our cookie consent banner.
            </li>
            <li>
              <strong>YouTube Videos:</strong> We embed YouTube videos using
              iFrames. When you consent to cookies, YouTube may set cookies to
              track your viewing activity. Please refer to{" "}
              <a
                href="https://policies.google.com/privacy"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <ul>
            <li>
              ...
              FontAwesome and Google Fonts, both of which are hosted locally on
              our server. Therefore, no personal data is shared with external
              services for font loading.
            </li>
          </ul>
          ...
          <p>
            ...
            provider, {content.hosting.name} may process log files for security
            and maintenance purposes. For more information on their privacy
          ...
          <h2>6. Your Rights</h2>
          <p>
            Under GDPR/DSGVO, you have the following rights concerning your
            personal data:
          </p>
          <ul>
