  ...
  return (
    <div>
      ...
      <p>
        ...
        <br />
        <strong>Perplexities on Mars</strong>
        <br />
        E-Mail: info[a]perplexitiesonmars.de
      </p>
      ...
      <p>
        Unsere Website wird von Netcup gehostet. Netcup kann als
        Hosting-Anbieter Log-Dateien zu Sicherheits- und Wartungszwecken
        verarbeiten. Weitere Informationen zu den Datenschutzpraktiken finden
        Sie in der{" "}
        <a
          href="https://www.netcup.eu/legal/datenschutzerklaerung.php"
          target="_blank"
          rel="noopener noreferrer"
          className="links"
        >
  ...
  return (
    <div>
      ...
      <p>
        ...
        <strong>Perplexities on Mars</strong>
        <br />
        Email: info[a]perplexitiesonmars.de
      </p>
      ...
      <p>
        Our website is hosted by Netcup. As the hosting provider, Netcup may
        process log files for security and maintenance purposes. For more
        information on their privacy practices, please refer to{" "}
        <a
          href="https://www.netcup.eu/legal/datenschutzerklaerung.php"
          target="_blank"
          rel="noopener noreferrer"
